...
exports.warn = exports.title = exports.question = exports.success = exports.print = exports.info = exports.error = void 0;
...
const fmt = {
    ...
    info: opts.noColors ? verbatim : chalk_1.default.hex('#888'),
    question: opts.noColors ? verbatim : chalk_1.default.hex('#55F'),
    success: opts.noColors ? verbatim : chalk_1.default.hex('#0A0'),
    title: opts.noColors ? verbatim : chalk_1.default.bold.hex('#55F'),
    underline: opts.noDecorations ? verbatim : chalk_1.default.underline,
    warn: opts.noColors ? verbatim : chalk_1.default.hex('#CA0'),
};
/**
 ...
 */
function error(literals, ...values) {
