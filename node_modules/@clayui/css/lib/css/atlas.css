...
.alert-success {
  ...
  .alert-success .alert-btn {
    ...
    .alert-success .alert-btn:active {
      background-color: #226a33;
      border-color: #226a33; }
    .alert-success .alert-btn[aria-expanded='true'], .alert-success .alert-btn.active, .alert-success .alert-btn.show,
...
.alert-info {
  ...
  .alert-info .alert-btn {
    ...
    .alert-info .alert-btn:active {
      background-color: #294f98;
      border-color: #294f98; }
    .alert-info .alert-btn[aria-expanded='true'], .alert-info .alert-btn.active, .alert-info .alert-btn.show,
...
.alert-warning {
  ...
  .alert-warning .alert-btn {
    ...
    .alert-warning .alert-btn:active {
      ...
      border-color: #a04500; }
    .alert-warning .alert-btn[aria-expanded='true'], .alert-warning .alert-btn.active, .alert-warning .alert-btn.show,
...
.alert-danger {
  ...
  .alert-danger .alert-btn {
    ...
    .alert-danger .alert-btn:active {
      background-color: #c31212;
      border-color: #c31212; }
    .alert-danger .alert-btn[aria-expanded='true'], .alert-danger .alert-btn.active, .alert-danger .alert-btn.show,
  ...
  .date-picker-nav .nav-btn {
    ...
    .date-picker-nav .nav-btn:active {
      ...
      .date-picker-nav .nav-btn:active:focus {
        box-shadow: 0 0 0 0.2rem rgba(11, 95, 255, 0.25); }
    .date-picker-nav .nav-btn[aria-expanded='true'], .date-picker-nav .nav-btn.active, .date-picker-nav .nav-btn.show,
